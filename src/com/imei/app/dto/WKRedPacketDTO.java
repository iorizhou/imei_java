...
public class WKRedPacketDTO {
	...
	public WKRedPacketDTO(long id,String name, String useCondition, long userId, String startDate, String endDate, String source,
			long amount, long conditionAmount, int status) {
		super();
		this.id = id;
		this.name = name;
		this.useCondition = useCondition;
