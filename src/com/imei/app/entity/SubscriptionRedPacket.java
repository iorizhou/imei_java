...
//预订金——红包
public class SubscriptionRedPacket {
	private long id;
	private String name;
	...
	public SubscriptionRedPacket(String name, String useCondition, long userId, String startDate, String endDate,
			String source, long amount, long conditionAmount,int status) {
		super();
		this.name = name;
		this.useCondition = useCondition;
		this.userId = userId;
