...
public class NewCommentReplyNotice {
	private long id;
	...
	public NewCommentReplyNotice(String newReply, String oriReply, String replyTime, long replyUserId, long origUserId,
			long diaryId) {
		super();
		this.newReply = newReply;
		this.oriReply = oriReply;
